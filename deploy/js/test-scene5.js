(function(){
	...
	var Scene5 = MKK.getNamespace('app.scene').Scene5;
	...
	if(!ns.app) {
		...
		p.setup = function() {
			...
			this.scene5.setup(0, 5000/*695*/, 0, 0);

			this.loadFonts();
		}

		p.init = function() {
			console.log('init test-scene 5');

			this.stage.addChild(this.scene5.container);

			this.scene5.init(this.stage);
		}
